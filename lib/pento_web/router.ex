defmodule PentoWeb.Router do
  ...
  pipeline :api_authenticated do
    plug PentoWeb.AuthAccessPipeline
  end

  pipeline :graphql do
    plug PentoWeb.Context
  end

  scope "/api" do
    pipe_through :graphql

    forward "/", Absinthe.Plug, schema: PentoWeb.Schema
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: PentoWeb.Telemetry, ecto_repos: [Pento.Repo]
    end
  end
  ...
  if Mix.env == :dev do
    forward "/graphiql", Absinthe.Plug.GraphiQL, schema: PentoWeb.Schema
  end
end
